...
function TampilRankingTahunanKecamatanAdmin(){
    ...
    return (
        <div >
            ...
            <h3 className="text-center">Ranking Tahunan Kecamatan {dataKecamatan}</h3>
            <MDBTable>
                <MDBTableHead>
                    <tr>
                        <th scope='col'>No</th>
            ...
            <Row className="d-flex justify-content-start">
                <Col md={12} className="d-flex justify-content-start">
                    ...
                    <MDBBtn 
                        ...
                        onClick={(e) => {
                            exportToCSV(laporan, `ranking_tahunan_${dataKecamatan}.csv`)
                        }}>Export Laporan
                    </MDBBtn>
                </Col>
            </Row>
...
export default TampilRankingTahunanKecamatanAdmin;