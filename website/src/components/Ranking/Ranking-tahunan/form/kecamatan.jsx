...
function RankingTahunanKecamatanAdmin () {
    ...
    const handleSubmit = (e) => {
        if(isEmpty(e)){
            ...
            window.location.href = `/admin/ranking/ranking-tahunan/kecamatan/hasil-data/?` + query
        }
    }
...
export default RankingTahunanKecamatanAdmin;