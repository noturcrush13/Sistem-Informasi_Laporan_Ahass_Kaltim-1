...
function TampilRankingBulananKabupatenAdmin(){
  ...
  const exportToCSV = (csvData, fileName) => {
    ...
    useEffect(() => {
        Axios.get(`http://localhost:3001/laporan/rankingbulananbykabupaten/${dataBulan}/${dataTahun}/${dataKabupaten}`, {
            headers: {
                "Authorization": `Bearer ${token}`,
            },
        }).then((response) => {
    ...
    return (
        <div >
            ...
            <h3 className="text-center">Ranking Bulanan Kabupaten {dataKabupaten}</h3>
            <MDBTable>
                <MDBTableHead>
                    <tr>
                        <th scope='col'>No</th>
            ...
            <Row className="d-flex justify-content-start">
                <Col md={12} className="d-flex justify-content-start">
                    ...
                    <MDBBtn 
                        ...
                        onClick={(e) => {
                            exportToCSV(laporan, `ranking_bulanan_${dataKabupaten}.csv`)
                        }}>Export Laporan
                    </MDBBtn>
                </Col>
            </Row>
...
export default TampilRankingBulananKabupatenAdmin;