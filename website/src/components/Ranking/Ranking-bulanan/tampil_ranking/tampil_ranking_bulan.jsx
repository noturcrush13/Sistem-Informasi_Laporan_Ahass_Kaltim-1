...
function TampilRankingBulananBulanAdmin(){
...
const exportToCSV = (csvData, fileName) => {
    ...
    return (
        <div >
            ...
            <h3 className="text-center">Ranking Bulanan Bulan {dataBulan}</h3>
            <MDBTable>
                <MDBTableHead>
                    <tr>
                        <th scope='col'>No</th>
            ...
            <Row className="d-flex justify-content-start">
                <Col md={12} className="d-flex justify-content-start">
                    ...
                    <MDBBtn 
                        ...
                        onClick={(e) => {
                            exportToCSV(laporan, `ranking_bulanan_${dataBulan}.csv`)
                        }}>Export Laporan
                    </MDBBtn>
                </Col>
            </Row>
...
export default TampilRankingBulananBulanAdmin;