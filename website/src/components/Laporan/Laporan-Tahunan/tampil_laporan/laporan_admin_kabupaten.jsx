...
function TampilLaporanTahunanKabupatenAdmin(){
    ...
    useEffect(() => {
        Axios.get(`http://localhost:3001/laporan/getrekaplaporantahunankabupaten/${dataTahun}/${dataKabupaten}`, {
            headers: {
                "Authorization": `Bearer ${token}`,
            },
        }).then((response) => {
    ...
    return (
        <div >
            ...
            <h3 className="text-center">Laporan Tahunan Kabupaten {dataKabupaten}</h3>
            <h3 className="text-center">Tahun {dataTahun}</h3>
            <MDBTable>
                <MDBTableHead>
                    <tr>
                        <th scope='col'>No</th>
...
export default TampilLaporanTahunanKabupatenAdmin;