...
function LaporanTahunanNoAhassAdmin () {
    ...
    const handleSubmit = (e) => {
        if(isEmpty(e)) {
            ...
            window.location.href = `/admin/laporan/laporan-tahunan/no-ahass/hasil-data/?${query}`;
            // alert (query);
        }
    }
...
export default LaporanTahunanNoAhassAdmin;