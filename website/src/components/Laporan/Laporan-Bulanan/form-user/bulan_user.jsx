...
function LaporanBulananBulanSayaUser () {
    ...
    const handleSubmit = (e) => {
        if(isEmpty(e)) {
            ...
            const query = `id_user=${id_user}&dataBulan=${dataBulan}&dataTahun=${dataTahun}`
            window.location.href = `/user/laporan/laporan-bulanan/bulan-saya/hasil-data/?` + query;
        }
...
export default LaporanBulananBulanSayaUser;