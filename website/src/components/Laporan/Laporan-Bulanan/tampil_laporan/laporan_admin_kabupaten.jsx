            ...
            <MDBTabsContent>
                <MDBTabsPane show={activeTab === 'tab1'}>
                    <Container className="d-flex justify-content-center">
                        <h3>Bar Chart Unit Entry Bulan {namaBulan(parseInt(dataBulan))} Kabupaten {dataKabupaten}</h3>
                    </Container>
                    <LineRechartComponent data={formatDataForGraph()} />
                </MDBTabsPane>
                <MDBTabsPane show={activeTab === 'tab2'}>
                    <Container className="d-flex justify-content-center">
                        <h3>Pie Chart Bulan {namaBulan(parseInt(dataBulan))} Kabupaten {dataKabupaten}</h3>
                    </Container>
                    <PieRechartComponent data={pieData} />
                </MDBTabsPane>
                <MDBTabsPane show={activeTab === 'tab3'}>
                    <Container className="d-flex justify-content-center">
                        <h3>Bar Chart Pendapatan Bulan {namaBulan(parseInt(dataBulan))} Kabupaten {dataKabupaten}</h3>
                    </Container>
                    <LiceRechartPendapatanComponent data={formatDataForPendapatan()} />
                </MDBTabsPane>
                <MDBTabsPane show={activeTab === 'tab4'}>
                    <Container className="d-flex justify-content-center">
                        <h3>Pie Chart Pendapatan Bulan {namaBulan(parseInt(dataBulan))} Kabupaten {dataKabupaten}</h3>
                    </Container>
